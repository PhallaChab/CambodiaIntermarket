                        ...
                        <li>
                        	<?php
								while ($obj = $product->fetch_object()) {
									echo "<a href=''>
	                                		<img class='etalage_thumb_image' src='resources/".$obj->pro_image."' class='img-responsive' />
	                            		</a>
	                            		<img class='etalage_source_image' src='resources/".$obj->pro_image."' class='img-responsive' title='' />
	                            		";
                    echo "</li>
                    </ul> 
